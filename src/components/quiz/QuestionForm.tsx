...
export function QuestionForm({
  ...
  const handleTypeChange = (type: Question['type']) => {
    ...
    if (type === 'TRUE_FALSE') {
      setFormData(prev => ({
        ...prev,
        correctAnswer: prev.correctAnswer || 'true',
      }));
    }
  };
  ...
  return (
    <Card className="w-full">
      <CardHeader>
        <CardTitle>{isEditing ? '問題を編集' : '新しい問題を作成'}</CardTitle>
      </CardHeader>
      <CardContent>
        <div className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            />
            {!formData.content && (
              <p className="text-destructive text-sm">問題文は必須項目です</p>
            )}
          </div>
                  ...
                  >
                    ...
                    {formData.type === 'SINGLE_CHOICE' ? (
                      <RadioGroup
                        ...
                        onValueChange={value =>
                          handleOptionCorrectChange(index, value === 'true')
                        }
                      >
                        <RadioGroupItem
                          value="true"
          ...
          <div className="space-y-4">
            ...
            {showHint && (
              <div className="space-y-2 pl-8">
                <div className="flex items-center">
                  <HelpCircle className="text-examforge-blue mr-2 h-4 w-4" />
            ...
            {showExplanation && (
              <div className="space-y-2 pl-8">
                <div className="flex items-center">
                  <BookOpen className="text-examforge-blue mr-2 h-4 w-4" />
