...
const messages = {
  ...
  'pricing.plans.premium.name': 'エンタープライズ',
  'pricing.plans.premium.price': 'お問い合わせ',
  'pricing.plans.premium.period': '',
  'pricing.plans.premium.description': '大規模な組織や企業に最適',
  'pricing.plans.premium.cta': 'お問い合わせ',
