...
-- CreateEnum
CREATE TYPE "LmsContentType" AS ENUM ('VIDEO', 'TEXT', 'PDF', 'QUIZ', 'ASSIGNMENT', 'EXTERNAL_LINK');

-- CreateEnum
CREATE TYPE "LmsEnrollmentStatus" AS ENUM ('ACTIVE', 'COMPLETED', 'EXPIRED', 'SUSPENDED');

-- CreateEnum
CREATE TYPE "LmsProgressStatus" AS ENUM ('NOT_STARTED', 'IN_PROGRESS', 'COMPLETED');
...
CREATE TABLE "LmsLesson" (
    ...
    "description" TEXT,
    "order" INTEGER NOT NULL,
    "contentType" "LmsContentType" NOT NULL,
    "content" JSONB,
    "duration" INTEGER,
    "quizId" TEXT,
...
CREATE TABLE "LmsLessonProgress" (
    ...
    "status" "LmsProgressStatus" NOT NULL DEFAULT 'NOT_STARTED',
...
CREATE TABLE "LmsCourseCategory" (
    ...
    CONSTRAINT "LmsCourseCategory_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "LmsCoursePrerequisite" (
    "id" TEXT NOT NULL,
    "courseId" TEXT NOT NULL,
    "prerequisiteId" TEXT NOT NULL,

    CONSTRAINT "LmsCoursePrerequisite_pkey" PRIMARY KEY ("id")
);
...
-- CreateTable
CREATE TABLE "_LmsCourseToLmsCourseCategory" (
    "A" TEXT NOT NULL,
    "B" TEXT NOT NULL,

    CONSTRAINT "_LmsCourseToLmsCourseCategory_AB_pkey" PRIMARY KEY ("A","B")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "LmsTenant_teamId_key" ON "LmsTenant"("teamId");

-- CreateIndex
CREATE UNIQUE INDEX "LmsTenant_subdomain_key" ON "LmsTenant"("subdomain");

-- CreateIndex
CREATE UNIQUE INDEX "LmsTenant_customDomain_key" ON "LmsTenant"("customDomain");

-- CreateIndex
CREATE INDEX "LmsTenant_teamId_idx" ON "LmsTenant"("teamId");

-- CreateIndex
CREATE INDEX "LmsTenant_subdomain_idx" ON "LmsTenant"("subdomain");

-- CreateIndex
CREATE INDEX "LmsTenant_customDomain_idx" ON "LmsTenant"("customDomain");

-- CreateIndex
CREATE INDEX "LmsCourse_tenantId_idx" ON "LmsCourse"("tenantId");

-- CreateIndex
CREATE INDEX "LmsCourse_slug_idx" ON "LmsCourse"("slug");

-- CreateIndex
CREATE INDEX "LmsCourse_status_idx" ON "LmsCourse"("status");

-- CreateIndex
CREATE UNIQUE INDEX "LmsCourse_tenantId_slug_key" ON "LmsCourse"("tenantId", "slug");

-- CreateIndex
CREATE INDEX "LmsModule_courseId_idx" ON "LmsModule"("courseId");

-- CreateIndex
CREATE INDEX "LmsModule_order_idx" ON "LmsModule"("order");

-- CreateIndex
CREATE INDEX "LmsLesson_moduleId_idx" ON "LmsLesson"("moduleId");

-- CreateIndex
CREATE INDEX "LmsLesson_order_idx" ON "LmsLesson"("order");

-- CreateIndex
CREATE INDEX "LmsLesson_quizId_idx" ON "LmsLesson"("quizId");

-- CreateIndex
CREATE INDEX "LmsEnrollment_tenantId_idx" ON "LmsEnrollment"("tenantId");
...
-- CreateIndex
CREATE INDEX "LmsLessonProgress_status_idx" ON "LmsLessonProgress"("status");

-- CreateIndex
CREATE UNIQUE INDEX "LmsLessonProgress_enrollmentId_lessonId_key" ON "LmsLessonProgress"("enrollmentId", "lessonId");

-- CreateIndex
CREATE INDEX "LmsCourseCategory_tenantId_idx" ON "LmsCourseCategory"("tenantId");

-- CreateIndex
CREATE INDEX "LmsCourseCategory_parentId_idx" ON "LmsCourseCategory"("parentId");

-- CreateIndex
CREATE UNIQUE INDEX "LmsCourseCategory_tenantId_slug_key" ON "LmsCourseCategory"("tenantId", "slug");

-- CreateIndex
CREATE INDEX "LmsCoursePrerequisite_courseId_idx" ON "LmsCoursePrerequisite"("courseId");

-- CreateIndex
CREATE INDEX "LmsCoursePrerequisite_prerequisiteId_idx" ON "LmsCoursePrerequisite"("prerequisiteId");

-- CreateIndex
CREATE UNIQUE INDEX "LmsCoursePrerequisite_courseId_prerequisiteId_key" ON "LmsCoursePrerequisite"("courseId", "prerequisiteId");

-- CreateIndex
CREATE INDEX "LmsComment_lessonId_idx" ON "LmsComment"("lessonId");

-- CreateIndex
CREATE INDEX "LmsComment_userId_idx" ON "LmsComment"("userId");
...
-- CreateIndex
CREATE INDEX "LmsCertificate_certificateNumber_idx" ON "LmsCertificate"("certificateNumber");

-- CreateIndex
CREATE INDEX "_LmsCourseToLmsCourseCategory_B_index" ON "_LmsCourseToLmsCourseCategory"("B");
...
-- AddForeignKey
ALTER TABLE "LmsTenant" ADD CONSTRAINT "LmsTenant_teamId_fkey" FOREIGN KEY ("teamId") REFERENCES "Team"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "LmsCourse" ADD CONSTRAINT "LmsCourse_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "LmsTenant"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "LmsLesson" ADD CONSTRAINT "LmsLesson_quizId_fkey" FOREIGN KEY ("quizId") REFERENCES "Quiz"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "LmsEnrollment" ADD CONSTRAINT "LmsEnrollment_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "LmsTenant"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "LmsCourseCategory" ADD CONSTRAINT "LmsCourseCategory_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "LmsTenant"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "LmsCourseCategory" ADD CONSTRAINT "LmsCourseCategory_parentId_fkey" FOREIGN KEY ("parentId") REFERENCES "LmsCourseCategory"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "LmsCoursePrerequisite" ADD CONSTRAINT "LmsCoursePrerequisite_courseId_fkey" FOREIGN KEY ("courseId") REFERENCES "LmsCourse"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "LmsCoursePrerequisite" ADD CONSTRAINT "LmsCoursePrerequisite_prerequisiteId_fkey" FOREIGN KEY ("prerequisiteId") REFERENCES "LmsCourse"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "LmsComment" ADD CONSTRAINT "LmsComment_lessonId_fkey" FOREIGN KEY ("lessonId") REFERENCES "LmsLesson"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "LmsComment" ADD CONSTRAINT "LmsComment_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "LmsCertificate" ADD CONSTRAINT "LmsCertificate_templateId_fkey" FOREIGN KEY ("templateId") REFERENCES "CertificateTemplate"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_LmsCourseToLmsCourseCategory" ADD CONSTRAINT "_LmsCourseToLmsCourseCategory_A_fkey" FOREIGN KEY ("A") REFERENCES "LmsCourse"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_LmsCourseToLmsCourseCategory" ADD CONSTRAINT "_LmsCourseToLmsCourseCategory_B_fkey" FOREIGN KEY ("B") REFERENCES "LmsCourseCategory"("id") ON DELETE CASCADE ON UPDATE CASCADE;
