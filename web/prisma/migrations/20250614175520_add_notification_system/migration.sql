...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('QUIZ_COMPLETED', 'QUIZ_SHARED', 'TEAM_INVITATION', 'TEAM_MEMBER_JOINED', 'SUBSCRIPTION_UPDATED', 'PAYMENT_FAILED', 'SYSTEM_UPDATE', 'CERTIFICATE_ISSUED', 'QUIZ_PUBLISHED', 'QUIZ_RESPONSE_RECEIVED', 'STORAGE_LIMIT_WARNING', 'PLAN_LIMIT_WARNING');
...
CREATE TABLE "notification_preferences" (
    ...
    "quiz_shared" BOOLEAN NOT NULL DEFAULT true,
