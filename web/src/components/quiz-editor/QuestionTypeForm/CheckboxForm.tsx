...
export function CheckboxForm({
  ...
  const t = useTranslations(
    'quizManagement.editor.questionTypes.multiplechoice'
  );
  ...
  const deleteOption = (id: string) => {
    ...
    onChange({ options: updatedOptions, correctAnswer: updatedCorrectAnswers });
  };
  ...
  const toggleCorrectAnswer = (id: string) => {
    ...
    const updatedCorrectAnswers = option.isCorrect
      ? (question.correctAnswer || []).filter(answerId => answerId !== id)
